...
export default function Next1() {
  return (
    <View style={styles.container}>
      ...
      <Image 
        source={require('../assets/Onboarding3.png')} // Make sure the path is correct
        style={styles.logoImage} 
      />
      
      {/* Text content */}
      <Text style={styles.h1}>Stay on top of vaccine schedules</Text>
      <Text style={styles.subtitle}>Use smart reminders to stay on top of that next Rabies shot.</Text>

      {/* "Next" button */}
      <Link style={styles.nextButton} href="/sign-up">
